...
\begin{enumerate}[start=1,label={RF-\arabic*.}]
    ...
    \item Las estadísticas (RF-21, RF-31) podrán mostrarse de forma total o filtradas por periodos de tiempo (semanas, meses, años...).
...
\begin{enumerate}[start=9,label={RF-\arabic*.}]
    ...
    \item La información de cada uno de los residentes se seguirá almacenando en el sistema aunque se le haya dado de baja de la fundación, a no ser que un administrador decida eliminar a la persona del sistema. 
    ...
    \item La aplicación tendrá un apartado dedicado a mostrar estadísticas sobre:
        \begin{itemize}
...
\begin{enumerate}[start=26,label={RF-\arabic*.}]
    ...
    \item Las estadísticas que debe cubrir la aplicación sobre los alojamientos serán:
        \begin{itemize}
...
\begin{enumerate}[start=5,label={RNF-\arabic*.}]
    ...
    \item Los datos asociados de los residentes serán:
        ...
        \end{itemize}
    \item Los residentes podrán tener una relación hijo/a-padre/madre entre ellos
    \item Los residentes podrán pertenecer a colectivos.
...
\begin{enumerate}[start=16,label={RNF-\arabic*.}]
...
\begin{enumerate}[start=16,label={RNF-\arabic*.}]
    ...
    \item Cada actividad tendrá asociada la siguiente información:
        \begin{itemize}
            ...
            \item Persona que realiza la actividad
            \item Descripción
            \item Fecha
        \end{itemize}
    \item Se almacenará información básica acerca de las personas que realizan las actividades:
        \begin{itemize}
            \item Nombre
            \item Descripción (cualidades, ...)
            \item Cargo actual (en caso de ser relevante para las actividades que tutoriza)
        \end{itemize}
\end{enumerate}