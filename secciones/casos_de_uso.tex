...
En cuanto a la gestión de las personas, los casos de uso ``Añadir personas'', ``Editar personas'', ``Crear / modificar / eliminar cita'', ``Consultar datos de personas'', ``Añadir o eliminar documentos de personas'' y ``Consultar documentos de personas'' son sencillos y de fácil comprensión, por lo que no necesitan una explicación extra. En cuanto a los dos restantes, los casos de uso ``Dar de alta / baja personas'' y ``Eliminar personas'' pueden dar pie a equivocaciones por su similitud. Para evitar esto, se han detallado en las tablas \ref{fig:cu_personas_altabaja} y \ref{fig:cu_personas_eliminar}.
