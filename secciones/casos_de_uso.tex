...
Para llegar a un primer acercamiento al funcionamiento del sistema, se han desarrollado una serie de diagramas de casos de uso para cada una de las secciones de la aplicación (gestión de usuarios, gestión de personas, gestión de alojamientos y gestión de actividades). Otras partes de la aplicación no han sido contempladas debido a que su comprensión está más cerca de la implementación que del análisis y diseño del proyecto, como es todo lo referente a las estadísticas y notificaciones.   
...
Las dependencias de los casos de uso ``Editar usuario'' y ``Eliminar usuario'' sobre ``Consultar la información de un usuario'' vienen principalmente dadas debido a que será necesario conocer la inforamción del usuario, tanto para editar esta como para eliminarlo. 
...
Los casos de uso ``Crear usuario'', ``Editar usuario'', ``Eliminar usuario'', ``Consular la información de un usuario'' y ``Logout'' tienen un funcionamiento simple y no necesitan ser desglosados. Por otra parte, para facilitar la comprensión del caso de uso de ``Login'', se ha desarrollado una descripción de este en la Tabla \ref{fig:cu_usuarios_login}.
...
Las dependencias principales entre los casos de uso son parecidas a la de los casos de uso de gestión de usuarios. Para realizar cualquier acción de modificación sobre una persona, esta acción dependerá de conocer la información de esta, contemplado en el caso de uso ``Consultar datos de personas''. El consultar los datos de las personas, podrá conllevar consultar y acceder a los documentos de esta misma, lo cual no será estrictamente necesario. De igual forma, para eliminar un documento será necesario conocer estos documentos, lo que provoca la relacion entre ``Añadir o eliminar documentos de personas'' y ``Consultar documentos de personas''. 
...
En cuanto a la gestión de las personas, los casos de uso ``Añadir personas'', ``Editar personas'', ``Crear / modificar / eliminar cita'', ``Consultar datos de personas'', ``Añadir o eliminar documentos de personas'' y ``Consultar documentos de personas'' son sencillos y de fácil comprensión, por lo que no necesitan una explicación extra. Los dos restantes, ``Dar de alta / baja personas'' y ``Eliminar personas'' pueden dar pie a equivocaciones por su similitud. Para evitar esto, se han detallado en las tablas \ref{fig:cu_personas_altabaja} y \ref{fig:cu_personas_eliminar}.
...
En este caso, al modificar una casa, será estrictamente necesario conocer la información de esta. Por otra parte, la modificación de la información de la casas no tiene porque suponer la modificación de residentes o habitaciones, lo que provoca las relaciones de extensión entre ``Modificar casas'' y ``Eliminar habitación'', ``Modificar habitación'' y ``Añadir habitación''. El caso de uso ``Modificar habitación de residentes'' se especifica de forma exclusiva, buscando concretar que será la única modificación posible para un usuario general.
...
En la gestión de las alojamientos, los casos de uso ``Añadir casa'', ``Eliminar casa'', ``Obtener información de la casa'', ``Eliminar habitación'' y ``Añadir habitación'' son sencillos, por lo que no necesitan una explicación avanzada. En cuanto a los dos restantes, los casos de uso ``Modificar habitación'' y ``Modificar habitación de resientes'' pueden causar confusión ya que uno aunque se relacionan entre si, no dependen uno del otro. Su comportamiento está detallado en las tablas \ref{fig:cu_alojamientos_modificar} y \ref{fig:cu_alojamientos_modificarresidentes}.
...
\begin{table}[hp!]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \textbf{Tipo}                                          & \multicolumn{3}{l|}{Primario}                                                                                       \\ 
        \hline
        \textbf{Referencias}                                   &  CU\_05               & \multicolumn{2}{l|}{}                                                                        \\ 
        \hline
...
\begin{table}[hp!]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \textbf{Tipo}                                          & \multicolumn{3}{l|}{Primario}                                                                                                       \\ 
        \hline
        \textbf{Referencias}                                   &    CU\_04              & \multicolumn{2}{l|}{}                                                                                        \\ 
        \hline
...
Por último, en la parte de la aplicación referente a las actividades, podrán acceder todos los usuarios. Los casos de uso aquí son bastante básicos. Estos están representados en el diagrama de casos de uso de la Figura \ref{fig:cu_actividades}. 
...
Igual que en los apartados previos, los casos de uso ``Añadir actividad'', ``Eliminar actividad'', ``Editar actividad'', ``Ver información de actividad'', ``Desapuntarse de una actividad'', ``Apuntarse a una actividad'' y ``Ver ranking y puntuación'' son sencillos, por lo que no necesitan una explicación avanzada. El único que puede generar dudas es ``Puntuar a los asistentes de una actividad'', el cual está detallado en la tabla \ref{fig:cu_actividades_puntuacion}.
